...
| Fáze | Dokumenty | Stav |
|------|-----------|------|
| **1 — Creative Direction** | Art Bible, ADR-A01, Environment Bible, Lighting Guide, Color Script | Rozpracovává se |
...
**[RULE]** Implementace v kódu není Source of Truth. Po schválení dokumentů se kód synchronizuje z docs — ne opačně.
...
├── 00_Strategy/
│     └── ADR-A01_Regional_Identity_Framework.md  # rozhodovací metodika (Fáze 1 #2)
