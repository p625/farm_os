...
| [Map_01_Agricultural_Master_Plan.md](Map_01_Agricultural_Master_Plan.md) | **SoT zemědělské logiky** | World Director |
...
`Map_01_Agricultural_Master_Plan`, poté `Map_01_Road_Network`, `Map_01_Field_Layout` … — viz sekce výše.
