...
interface InteractionRadialMenuProps {
  menu: InteractionContextMenuSnapshot
  onAction: (action: InteractionRadialActionKind) => void
  onDismiss: () => void
}
...
export function InteractionRadialMenu({
  menu,
  onAction,
  onDismiss,
}: InteractionRadialMenuProps) {
  ...
  return (
    ...
    >
      ...
      {menu.actions.map((action, index) => {
        ...
        const isCancel = action === InteractionRadialActionKind.Cancel
